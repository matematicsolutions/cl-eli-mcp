...
Pulls a tiny static ``cl-runtime.json.gz`` from this repo's GitHub Release on
first tool call so a dead endpoint can be repointed (edit runtime/cl-runtime.json
...
Opt-out: set ``CL_ELI_RUNTIME_URL=""`` to disable the fetch.
"""
...
MANIFEST_URL = os.environ.get(
    "CL_ELI_RUNTIME_URL",
    "https://github.com/matematicsolutions/cl-eli-mcp/releases/latest/download/cl-runtime.json.gz",
)
_CACHE_NAME = "cl-runtime.json"
_TIMEOUT = 15
_USER_AGENT = "cl-eli-mcp-runtime (+https://github.com/matematicsolutions/cl-eli-mcp)"
